...
export const dnsProviders: DnsProvider[] = [
  {
    id: "dns4eu",
    name: "DNS4.EU (Protección Familiar)",
    website: "https://www.dns4.eu",
    description:
      "DNS4.EU es un proveedor europeo de DNS gestionado por CZ.NIC (asociación checa sin ánimo de lucro). Su perfil **family** bloquea contenido pornográfico, violencia, apuestas, malware y discursos de odio. Es la opción ideal por su enfoque europeo, cumplimiento RGPD total y modelo sin ánimo de lucro.",
    primaryIPv4: "91.239.100.101",
    secondaryIPv4: "91.239.100.102",
    primaryIPv6: "2001:678:440:3300::10101",
    secondaryIPv6: "2001:678:440:3300::10102",
    dohUrl: "https://family.dns4.eu/dns-query",
    dotAddress: "family.dns4.eu",
    filtering: "familia",
    tier: "gratuito",
    difficulty: "facil",
    features: [
      "Bloqueo de pornografía y contenido violento",
      "Bloqueo de apuestas online",
      "Bloqueo de discursos de odio",
      "Protección contra malware y phishing",
      "Sin registro de logs (RGPD total)",
      "DNS sobre HTTPS (DoH) y TLS (DoT)",
      "Gestionado por CZ.NIC — sin ánimo de lucro",
      "No tiene versión de pago (no hay conflicto de intereses)",
    ],
    pros: [
      "Cumple RGPD — no guarda registros",
      "Sin ánimo de lucro (CZ.NIC)",
      "Bloqueo completo: adultos + violencia + apuestas + odio",
      "Gratuito sin límite de uso ni registro",
      "Basado en Europa (República Checa)",
      "Sin versión de pago — no hay incentivo para limitar lo gratuito",
    ],
    cons: [
      "Menos conocido que otras opciones",
      "No tiene panel de control familiar",
      "No permite personalizar listas de bloqueo",
      "La red de servidores es más pequeña que Cloudflare",
    ],
    recommended: true,
    europeBased: true,
    logsPolicy: "Sin logs — política estricta de no registro. Gestionado por CZ.NIC.",
  },
  {
