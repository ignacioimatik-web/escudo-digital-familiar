...
import { Clock, CheckCircle2, ArrowRight, Smartphone, Monitor, Router, Globe } from "lucide-react"
...
export function GuidePage({
  ...
  const Icon = iconMap[guide.icono] || Smartphone
  ...
  return (
    <>
      <Section className="relative overflow-hidden">
        ...
        <Container size="md">
          ...
          <div className="flex flex-wrap gap-3">
            <Badge
              variant={difficultyVariant[guide.dificultad]}
        ...
        <Container size="md">
          <div className="mb-8">
            ...
            <p className="text-slate-500">
              Sigue estos pasos en orden para configurar la protección completa.
            </p>
          </div>
      ...
      {guide.advertencias.length > 0 && (
        <Section className="bg-slate-50/50">
          <Container size="md">
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-slate-900 mb-2">Advertencias importantes</h2>
              <p className="text-slate-500">
                Presta atención a estos puntos para que la protección funcione correctamente.
              </p>
            </div>
      ...
      <Section>
        <Container size="md">
          ...
          {guide.erroresFrecuentes.length > 0 && (
            <div className="mb-8">
      ...
      <Section className="bg-gradient-to-b from-brand-50/40 to-background">
        <Container className="text-center">
          <Icon className="h-12 w-12 text-brand-600 mx-auto mb-6" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            {nextGuide && (
              ...
              >
                Siguiente guía: {nextGuide.label}
              </Link>
            )}
          </div>
        </Container>
