...
import { Monitor, Clock, ArrowRight, CheckCircle2 } from "lucide-react"
...
const guide = getDeviceGuide("windows")!
    ...
    <>
      ...
      <Section className="bg-gradient-to-b from-brand-50/40 to-background">
        <Container className="text-center">
          <Monitor className="h-12 w-12 text-brand-600 mx-auto mb-6" />
