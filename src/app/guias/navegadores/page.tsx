...
import { Globe, Clock, ArrowRight, CheckCircle2 } from "lucide-react"
...
const guide = getDeviceGuide("navegador")!
    ...
    <>
      ...
      <Section className="bg-gradient-to-b from-brand-50/40 to-background">
        <Container className="text-center">
          <Globe className="h-12 w-12 text-brand-600 mx-auto mb-6" />
