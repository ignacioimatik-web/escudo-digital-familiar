...
const slides: SlideData[] = [
  ...
  { id: 1, type: "fact", icon: AlertTriangle, titulo: "Una generación sin manual de instrucciones", color: "accent", bullets: ["9 años: la edad media del primer móvil propio", "9 de cada 10 ven pornografía antes de los 14", "Más de 5 horas de pantalla al día, todos los días", "Y casi nada frenándolo por el camino"], img: "/images/presentaciones/child-screen.jpg" },
  { id: 2, type: "center", variant: "keynote", eyebrow: "No es culpa de nadie", titulo: "El diseño está hecho para atraparlos", color: "brand", texto: "Cada notificación, cada scroll infinito, cada autoplay. Detrás hay equipos enteros de ingenieros trabajando para no soltar su atención.", img: "/images/presentaciones/tech.jpg" },
  ...
  { id: 4, type: "center", variant: "keynote", titulo: "No basta educar sin proteger", color: "cyan", texto: "Un niño de 8 años no tiene criterio para frenarse solo. Proteger es el primer paso, no el último, para poder educar.", img: "/images/presentaciones/family-1.jpg" },
  ...
  { id: 6, type: "detail", icon: Wifi, titulo: "Capa 1: DNS de protección", color: "brand", bullets: ["El DNS es la agenda telefónica de Internet", "Bloquea dominios maliciosos y pornográficos antes de cargar", "Protege TODOS los dispositivos de la red, sin excepción", "Gratis. 5 minutos. Se configura y se olvida"], img: "/images/presentaciones/network-globe.jpg" },
  { id: 7, type: "detail", icon: Smartphone, titulo: "Capa 2: Control parental", color: "cyan", bullets: ["Android: Google Family Link, 10 minutos", "iOS: En Familia + Tiempo de Uso, control por edad", "Límites de tiempo, apps restringidas, compras bloqueadas", "Acompañar mientras aprenden, no solo vigilar"], img: "/images/presentaciones/social.jpg" },
  ...
  { id: 11, type: "final", icon: Heart, titulo: "Proteger para educar", subtitulo: "Educar para liberar.", desc: "No se trata de construir muros. Se trata de acompañar mientras aprenden a navegar el mundo digital con libertad y responsabilidad.", color: "success", img: "/images/presentaciones/family-2.jpg" },
]
