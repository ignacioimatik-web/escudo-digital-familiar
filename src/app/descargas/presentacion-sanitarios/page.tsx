...
const slides: SlideData[] = [
  { id: 0, type: "title", icon: Stethoscope, eyebrow: "Salud digital", titulo: "La pantalla ya es un signo vital más.", subtitulo: "Pregúntalo como preguntas por el sueño.", texto: "Evidencia y recursos para pediatría y atención primaria.", img: "/images/presentaciones/health.jpg" },
  { id: 1, type: "fact", icon: AlertTriangle, titulo: "Datos que ya no podemos ignorar", color: "accent", bullets: ["OMS: 0 pantallas antes de los 2 años, máximo 1h de 2 a 5", "40% de los niños de 7 años accede a Internet sin supervisión", "La exposición temprana se asocia con retraso del lenguaje", "Sueño, atención y salud mental, afectados por el uso excesivo"], img: "/images/presentaciones/doctor-child.jpg" },
  { id: 2, type: "center", variant: "keynote", eyebrow: "No es falta de disciplina", titulo: "El diseño está hecho para atraparlos", color: "brand", texto: "Ningún paciente pediátrico compite en igualdad contra algoritmos diseñados para capturar atención. La prevención empieza reconociendo esto.", img: "/images/presentaciones/stethoscope-child.jpg" },
  { id: 3, type: "center", variant: "keynote", titulo: "No basta informar sin herramientas", color: "brand", texto: "Decirle a una familia 'menos pantalla' sin darle un método concreto es como recetar dieta sin plan de comidas. No se sostiene.", img: "/images/presentaciones/child-screen.jpg" },
  { id: 4, type: "center", variant: "keynote", titulo: "No bastan herramientas sin seguimiento", color: "cyan", texto: "Configurar un filtro una vez no es prevención, es un parche. La salud digital, como cualquier otra, se revisa en cada consulta.", img: "/images/presentaciones/family-1.jpg" },
  ...
  { id: 6, type: "detail", icon: Baby, titulo: "Capa 1: límites por edad (OMS/AAP)", color: "brand", bullets: ["0-2 años: cero pantallas, salvo videollamada familiar", "2-5 años: máximo 1h/día, siempre acompañado", "6-12 años: 1-2h/día de ocio digital, con supervisión", "13-17 años: negociar límites, priorizar sueño y deporte"], img: "/images/presentaciones/network-globe.jpg" },
  ...
  { id: 9, type: "detail", icon: Shield, titulo: "Qué recomendar hoy mismo", color: "brand", bullets: ["DNS4.EU (family.dns4.eu): gratuito, europeo, sin datos personales", "Family Link (Android) o Tiempo de Uso (iOS): 15-30 min", "Incluir la pregunta en cada revisión, no solo una vez", "Entregar la guía rápida en papel, no solo de palabra"], img: "/images/presentaciones/tech.jpg" },
