...
const slides: SlideData[] = [
  ...
  { id: 1, type: "fact", icon: AlertTriangle, titulo: "Datos que no podemos ignorar", color: "accent", bullets: ["La OMS recomienda 0 pantallas antes de los 2 anos y maximo 1h/dia de 2 a 5", "El 40% de los ninos de 7 anos ya tiene acceso a Internet sin supervision", "La exposicion temprana a pantallas se asocia con retraso en el lenguaje", "El sueno, la atencion y la salud mental se ven afectados por el uso excesivo"], img: "/images/presentaciones/doctor-child.jpg" },
  { id: 2, type: "fact", icon: Brain, titulo: "Impactos documentados en salud infantil", color: "accent", bullets: ["Trastornos del sueno: la luz azul inhibe la melatonina hasta 2 horas", "Obesidad infantil: el sedentarismo digital se correlaciona con IMC elevado", "Problemas de atencion: la multitarea digital afecta la capacidad de concentracion", "Salud mental: ansiedad, depresion y comparacion social en adolescentes"], img: "/images/presentaciones/stethoscope-child.jpg" },
  { id: 3, type: "center", titulo: "El entorno digital es un determinante de salud", color: "brand", texto: "Igual que preguntamos por alimentacion, ejercicio y vacunas, debemos preguntar por el uso de pantallas. La salud digital es ya una parte fundamental de la salud infantil.", img: "/images/presentaciones/child-screen.jpg" },
  ...
  { id: 6, type: "detail", icon: Baby, titulo: "Recomendaciones por edades (evidencia OMS/AAP)", color: "brand", bullets: ["0-2 anos: cero pantallas (excepto videollamadas con familiares)", "2-5 anos: maximo 1 hora/dia, siempre acompanado de un adulto", "6-12 anos: maximo 1-2 horas/dia de ocio digital, con supervision", "13-17 anos: negociar limites, priorizar sueno y actividad fisica"], img: "/images/presentaciones/network-globe.jpg" },
  { id: 7, type: "detail", icon: Clock, titulo: "Indicadores de alarma en la consulta", color: "accent", bullets: ["El menor se muestra irritable cuando no tiene el dispositivo", "Duerme menos de 8 horas y tiene dificultad para despertarse", "Ha bajado el rendimiento escolar sin otra causa aparente", "Prefiere la pantalla a jugar con amigos o hacer deporte"], img: "/images/presentaciones/digital-shield.jpg" },
