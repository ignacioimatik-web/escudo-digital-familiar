...
const slides: SlideData[] = [
  ...
  { id: 3, type: "center", variant: "keynote", titulo: "No basta acompañar sin proteger", color: "brand", texto: "Un niño no tiene criterio para frenarse solo ante lo que ve. Proteger es el primer gesto de cuidado, antes incluso de la palabra.", img: "/images/presentaciones/family-warm.jpg" },
  { id: 4, type: "center", variant: "keynote", titulo: "No basta proteger sin acompañar", color: "cyan", texto: "Los filtros se sortean. Lo que de verdad forma es la palabra, la catequesis, la cercanía. Sin acompañamiento, la protección es frágil.", img: "/images/presentaciones/community.jpg" },
  ...
  { id: 9, type: "detail", icon: BookOpen, titulo: "Cómo empezar en la parroquia", color: "brand", bullets: ["1. DNS de protección en el router (15 minutos)", "2. Sesión de formación de 1 hora para catequistas", "3. Charla-taller para familias tras la misa (30 min)", "4. Guía rápida y cartel entregados a cada familia"], img: "/images/presentaciones/hands-helping.jpg" },
  { id: 10, type: "center", eyebrow: "Recursos Sentinel", titulo: "Todo listo para vuestra comunidad", color: "cyan", texto: "escudodigitalfamiliar.org — carteles, guías, acuerdo familiar y esta presentación lista para adaptar. Sin coste.", img: "/images/presentaciones/community.jpg" },
  { id: 11, type: "final", icon: Cross, titulo: "Proteger es amar", subtitulo: "Cuidar a los pequeños es cuidar el futuro.", desc: "Dejad que los niños vengan a mí (Mc 10,14). Protegerlos en el mundo digital es una forma concreta de vivir el Evangelio hoy.", color: "success", img: "/images/presentaciones/nature-peace.jpg" },
]
