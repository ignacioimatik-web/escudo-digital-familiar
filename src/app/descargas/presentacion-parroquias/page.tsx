...
const slides: SlideData[] = [
  ...
  { id: 1, type: "fact", icon: AlertTriangle, titulo: "El mundo digital tambien necesita pastoral", color: "accent", bullets: ["Los ninos y jovenes de tu parroquia viven gran parte de su vida online", "El 90% accede a pornografia antes de los 14, a menudo sin buscarlo", "Las redes sociales son el nuevo parque donde se relacionan", "La parroquia no puede estar ausente de esta realidad"], img: "/images/presentaciones/community.jpg" },
  { id: 2, type: "fact", icon: AlertTriangle, titulo: "Una llamada a la responsabilidad", color: "accent", bullets: ["La Iglesia tiene el deber de proteger a los mas pequenos", "Los catequistas y monitores son figuras de referencia y confianza", "Las familias esperan orientacion de la comunidad parroquial", "La proteccion digital es una forma concreta de caridad"], img: "/images/presentaciones/hands-helping.jpg" },
  { id: 3, type: "center", titulo: "No se trata de tecnologia. Se trata de personas.", color: "brand", texto: "Detras de cada pantalla hay un hijo de Dios. La proteccion digital no es un tema tecnico - es una cuestion de amor, cuidado y responsabilidad comunitaria.", img: "/images/presentaciones/family-1.jpg" },
  { id: 4, type: "center", titulo: "El reto de nuestro tiempo", color: "brand", texto: "La tecnologia avanza mas rapido que nuestra capacidad de acompanar. Pero la Iglesia tiene algo que el mundo digital no puede dar: comunidad, verdad y amor incondicional.", img: "/images/presentaciones/family-2.jpg" },
  ...
  { id: 6, type: "detail", icon: Wifi, titulo: "Proteger la red de la parroquia", color: "brand", bullets: ["Configura DNS de proteccion en el router de la parroquia", "DNS4.EU Child Protection - europeo, sin animo de lucro, gratuito", "Protege todos los dispositivos conectados a la WiFi parroquial", "Ideal para salas de catequesis, grupos juveniles y despachos"], img: "/images/presentaciones/church.jpg" },
  { id: 7, type: "detail", icon: Heart, titulo: "Acompanar desde la fe", color: "accent", bullets: ["Integrar la educacion digital en la catequesis de Confirmacion", "Hablar del uso de redes sociales desde los valores del Evangelio", "Ayudar a los jovenes a discernir que contenido alimenta su alma", "Formar a catequistas para que sean referentes digitales"], img: "/images/presentaciones/nature.jpg" },
