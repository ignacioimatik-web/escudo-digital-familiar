...
const slides: SlideData[] = [
  ...
  { id: 1, type: "fact", icon: AlertTriangle, titulo: "Nadie les preparó para esto", color: "accent", bullets: ["9 años: la edad media del primer móvil propio", "9 de cada 10 ven pornografía antes de los 14", "5 horas de pantalla al día, todos los días", "Y casi nada frenándolo por el camino"], img: "/images/presentaciones/child-phone.jpg" },
  { id: 2, type: "center", variant: "keynote", eyebrow: "No es culpa tuya", titulo: "El diseño está hecho para atraparlos", color: "brand", texto: "Cada notificación, cada scroll infinito, cada autoplay. Compites contra un equipo de ingenieros que trabaja para no soltarlos.", img: "/images/presentaciones/tech-abstract.jpg" },
  { id: 3, type: "center", variant: "keynote", titulo: "No basta educar sin proteger", color: "brand", texto: "Un niño de 8 años no tiene criterio para frenarse solo. Proteger es el primer paso para poder educar.", img: "/images/presentaciones/family-warm.jpg" },
  ...
  { id: 10, type: "center", eyebrow: "Recursos Sentinel", titulo: "Todo lo que necesitas, gratis", color: "cyan", texto: "escudodigitalfamiliar.org — guías paso a paso, configurador interactivo y comparador de DNS. Para siempre gratis.", img: "/images/presentaciones/family-conversation.jpg" },
  { id: 11, type: "final", icon: Heart, titulo: "Proteger para educar", subtitulo: "Educar para liberar.", desc: "No se trata de construir muros. Se trata de acompañar a tus hijos mientras aprenden a navegar el mundo digital con libertad y responsabilidad.", color: "success", img: "/images/presentaciones/nature-peace.jpg" },
]
