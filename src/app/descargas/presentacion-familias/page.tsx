...
const slides: SlideData[] = [
  { id: 0, type: "title", icon: Shield, titulo: "Protege a tus hijos en el mundo digital", subtitulo: "Un metodo sencillo, gratuito y eficaz en dos capas", texto: "Para familias que quieren lo mejor para sus hijos", img: "/images/presentaciones/family-1.jpg" },
  ...
  { id: 2, type: "fact", icon: AlertTriangle, titulo: "No es mala voluntad. Es diseno.", color: "accent", bullets: ["Las apps estan disenadas para captar atencion infantil", "Los algoritmos amplifican contenido extremo sin control", "Las notificaciones crean adiccion en cerebros en desarrollo", "Los menores no tienen culpa - necesitan proteccion"], img: "/images/presentaciones/social.jpg" },
  { id: 3, type: "center", titulo: "No basta educar sin proteger", color: "brand", texto: "Un nino de 8 anos no tiene criterio para filtrar. La exposicion temprana deja huella imborrable. Proteger es el primer paso para educar.", img: "/images/presentaciones/family-2.jpg" },
  { id: 4, type: "center", titulo: "No basta proteger sin educar", color: "brand", texto: "Los filtros se pueden eludir. El objetivo final no es encerrar, sino formar criterio propio. Sin dialogo, la proteccion es fragil.", img: "/images/presentaciones/nature.jpg" },
  ...
  { id: 7, type: "detail", icon: Smartphone, titulo: "Capa 2: Control parental", color: "cyan", bullets: ["Android: Google Family Link - descarga y configura en 10 min", "iOS: En Familia + Tiempo de Uso - control por edades", "Pon limites de tiempo, restringe apps, bloquea compras", "Acompanalos mientras aprenden a usar la tecnologia"], img: "/images/presentaciones/teaching.jpg" },
