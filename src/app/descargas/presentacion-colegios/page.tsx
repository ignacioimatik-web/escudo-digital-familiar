...
const slides: SlideData[] = [
  ...
  { id: 1, type: "fact", icon: AlertTriangle, titulo: "Realidad digital en las aulas", color: "accent", bullets: ["El 95% de los alumnos de secundaria tiene movil propio", "1 de cada 3 ha sufrido ciberacoso en el entorno escolar", "Los menores pasan mas horas frente a pantallas que en el aula", "El colegio es el segundo hogar digital de los alumnos"], img: "/images/presentaciones/child-screen.jpg" },
  { id: 2, type: "fact", icon: AlertTriangle, titulo: "El centro educativo como espacio protegido", color: "accent", bullets: ["La ley obliga a proteger a los menores en el entorno digital del centro", "La red WiFi del colegio debe ser un espacio seguro", "Los docentes necesitan formacion en proteccion digital", "La coordinacion con las familias es clave para la efectividad"], img: "/images/presentaciones/school.jpg" },
  ...
  { id: 5, type: "center", titulo: "Frente 3: Coordinacion con familias", color: "cyan", texto: "El centro como puente: proporciona a las familias los recursos y la formacion para que la proteccion continue en casa. Charlas, guias, material descargable.", img: "/images/presentaciones/family-1.jpg" },
  { id: 6, type: "detail", icon: Wifi, titulo: "Proteger la red del centro", color: "brand", bullets: ["Configurar DNS de proteccion en el router y puntos de acceso", "DNS4.EU (91.239.100.101) - gratuito, europeo, sin logs", "Segmentar la red: red para alumnos, otra para administracion", "Cobertura WiFi protegida en todo el recinto escolar"], img: "/images/presentaciones/tech.jpg" },
